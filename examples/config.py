...
parser.add_argument('--use_model', type=str, default='transformer', help='model for train, seq2seq, wavenet, transformer')
parser.add_argument('--data_dir', type=str, default='../data/pcr.csv', help='data directory')
